...
# eliminates edges encoding a single co-participation. Should reduce to the network of "deep", or "prolonged" collaboration
...
def main(graph): 
	...
	deepCollab = graph.addSubGraph('deepCollab')
	for n in graph.getNodes():
		deepCollab.addNode(n)
	for e in graph.getEdges():
		if projectsTogether.getEdgeValue(e) > 1:
			deepCollab.addEdge(e)
